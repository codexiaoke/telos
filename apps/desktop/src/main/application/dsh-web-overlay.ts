...
const TELOS_COMPANION_PACKAGE = '@telos/dsh-companion'
...
export function prepareTelosDshWebPatch(
  ...
  removeLegacyFlatPackage(dshHome, TELOS_COMPANION_PACKAGE)
  ...
  installProfilePackage(dshHome, sources.companionPackageRoot, TELOS_COMPANION_PACKAGE, ['lib/index.js', 'lib/client.js'])
