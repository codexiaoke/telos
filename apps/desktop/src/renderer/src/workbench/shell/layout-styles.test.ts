...
describe('TELOS_LAYOUT_CSS', () => {
  ...
  it('provides the editor mode three-column shell and titlebar toggle', () => {
    ...
    expect(TELOS_LAYOUT_CSS).not.toContain('grid-template-columns: 260px minmax(420px, 1fr) minmax(360px, 34vw);')
    expect(TELOS_LAYOUT_CSS).toContain('.telos-view-mode-toggle')
    expect(TELOS_LAYOUT_CSS).toContain('.telos-workbench-resizer')
