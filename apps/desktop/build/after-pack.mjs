...
export default async function afterPack(context) {
  ...
  copyPlugin(join(repositoryRoot, 'plugins/dsh-personalization'), join(resourcesDirectory, 'dsh-overlays/telos-personalization'))
  copyPlugin(join(repositoryRoot, 'plugins/dsh-companion'), join(resourcesDirectory, 'dsh-overlays/telos-companion'))
