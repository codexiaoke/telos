...
export function resolveTelosDshCompanionPackageRoot(): string {
  return app.isPackaged
    ? join(process.resourcesPath, 'dsh-overlays/telos-companion')
    : join(developmentRepositoryRoot(), 'plugins/dsh-companion')
}
...
export function resolveTelosDshMultiRootWorkspacePackageRoot(): string {
  return app.isPackaged
    ...
    : join(developmentRepositoryRoot(), 'plugins/dsh-multi-root-workspace')
}
...
export function resolveTelosDshComputerUsePackageRoot(): string {
  return app.isPackaged
    ? join(process.resourcesPath, 'dsh-overlays/telos-computer-use')
    : join(developmentRepositoryRoot(), 'plugins/dsh-computer-use')
}
